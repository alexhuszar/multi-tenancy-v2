...
const getSearchInputContainerStyles = ({
  ...
  return twMerge(
    cn('mt-1 grid items-center w-full md:max-w-[400px]'),
    className,
  );
};
...
const getSearchInputAdornmentStyles = ({
  className,
}: {
  className?: string;
}) => {
  return twMerge(
    cn('col-start-1 row-start-1 justify-self-end pr-3 pointer-events-none'),
    className,
  );
};
