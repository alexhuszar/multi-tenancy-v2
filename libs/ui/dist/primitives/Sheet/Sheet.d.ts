...
export declare const Sheet: ({ open, onOpenChange, overlayClassName, contentClassName, titleClassName, className, position, children, }: SheetProps) => import("react/jsx-runtime").JSX.Element;
